...
final Data defaultData = Data((b) => b
  ...
  ..records = ListBuilder<Record>([
    ...
    Record.simple("GDD China", DateTime.utc(2018, 9, 21), const Duration(days: 2)),
    ...
    Record.simple(
        "ReactiveConf Prague", DateTime.utc(2018, 10, 31), const Duration(days: 3)),
    ...
    Record.simple("Devoxx BE", DateTime.utc(2018, 11, 17), const Duration(days: 5)),
    Record.simple(
